...
public class Abnormal extends TaskContent {
    ...
    public void erro() throws Exception {
        result = mFairy.findPic(3,293,117,1045,"shijie.png");
        result1 = mFairy.findPic(3,293,117,1045,"xiaoxi.png");
        if (result.sim > 0.8f || result1.sim > 0.8f) {
            mFairy.onTap(364,11,369,16,"聊天退出", Sleep);
        }

        result =mFairy.findPic(348,1119,701,1269,"xyty.png");
        mFairy.onTap(0.8f,result,"err协议同意",Sleep);

        result =mFairy.findPic(40,779,693,976,"xunyao.png");
        mFairy.onTap(0.8f,result,23,1220,28,1228,"err寻妖退出",Sleep);

        result =mFairy.findPic(252,756,476,835,"queding1.png");
