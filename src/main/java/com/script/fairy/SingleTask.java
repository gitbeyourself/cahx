    ...
    public void zlt() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                result =mFairy.findPic(136,1096,637,1275,"wanfa.png");
                if (result.sim > 0.8f){
                    mFairy.taskSlid(err, new int[]{0,1,2,3,4,5,6,7,8}, 0,  228,1095,588,1087, 1000, 1500,3);
                }
                ...
                result1 = mFairy.findPic(604,826,711,1173,"paihang.png");
            ...
            public void content_2() throws Exception {
                ...
                result = mFairy.findPic(237,91,468,1076,new String[]{"gq1.png","guanqia.png","guanqia1.png","gq.png"});
                mFairy.onTap(0.8f, result, "关卡选择", Sleep);
                ...
                result2 =mFairy.findPic(267,363,666,548,"tssl.png");
                if (result.sim > 0.8f || result1.sim > 0.8f || result2.sim > 0.8f) {
            ...
            public void content_1() throws Exception {
                ...
                if (result.sim > 0.8f){
                    ...
                    if (AtFairyConfig.getOption("shangpin").equals("1") || AtFairyConfig.getOption("zhenpin").equals("1") || AtFairyConfig.getOption("gupin").equals("1")){
                        ...
                        result4 =mFairy.findPic(19,839,159,981,str);
                        if (result1.sim > 0.8f) {
                        ...
                        if (result4.sim > 0.8f) {
                            result =mFairy.findPic(result4.x+499,result4.y-3,result4.x+635,result4.y+76,"jiequ1.png");
                            if (result.sim > 0.8f) {
                                mFairy.onTap(0.8f, result, "接取5", Sleep);
                                err=0;
                                s++;
                            }
                        }
                ...
                result =mFairy.findPic(401,772,662,861,"queren.png");
                ...
                if (result.sim > 0.8f || result1.sim > 0.8f || js>=2||s>=5) {
                    LtLog.e("不能接取或没有能量");
                    s=0;
                    js=0;
                    js1=0;
    ...
    public void reward() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result =mFairy.findPic(59,726,645,869,"rylq.png");
                if (result.sim>0.8f){
                    LtLog.e("存储上限！");
                    mFairy.onTap(0.8f,result,183,789,195,799,"仍要领取",1000);
                }
            ...
            public void content_5() throws Exception {
                ...
                result = mFairy.findPic(135,775,585,1078, new String[]{"lingqu2.png","lingqu3.png","lq4.png"});
                if (result.sim > 0.8f) {
                    mFairy.onTap(0.8f, result, "领取", Sleep);
                    err=0;
                }
                result = mFairy.findPic(176,332,553,483,"bbm.png");
                result1 = mFairy.findPic(239,280,481,449,"zdlh.png");
                if (result.sim > 0.8f || result1.sim > 0.8f) {
                    setTaskName(6);
                }
            }
    ...
    public void zmjj() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_1() throws Exception {
                ...
                result =mFairy.findPic(359,711,679,874,"jxtz1.png");
                mFairy.onTap(0.8f,result,"继续挑战",Sleep);
    ...
    public void zkzg() throws Exception {
        new SingleTask(mFairy) {
            ...
            public void content_2() throws Exception {
                ...
                result =mFairy.findPic(2,323,715,456,"zhaoji.png");
                if (result.sim>0.8f){
                    err=0;
                    LtLog.e("人数不足");
                    mFairy.initMatTime();
                ...
                result =mFairy.findPic(270,264,481,438,"zkbx.png");
                mFairy.onTap(0.8f,result,"钟馗宝箱",1000);

                result =mFairy.findPic(195,971,535,1137,"jxzg.png");
                mFairy.onTap(0.8f,result,"继续捉鬼",1000);
                mFairy.onTap(0.8f,result,665,107,673,112,"关闭",1000);
            ...
            public void content_4() throws Exception {
                ...
                result =mFairy.findPic(486,130,712,194,"duiwu1.png");
                mFairy.onTap(0.8f,result,"队伍",1000);

                result =mFairy.findPic(486,130,712,194,"duiwu2.png");
                mFairy.onTap(0.8f,result,"队伍2",1000);

                result =mFairy.findPic(67,1078,662,1218,"lidui.png");
                if (result.sim>0.8f){
